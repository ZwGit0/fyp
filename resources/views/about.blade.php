    ...
    <div class="about-container">
        ...
        <section class="cta-section">
            ...
            <div class="cta-buttons">
                ...
                @if(auth('web')->check())
                    <a href="{{ route('home') }}" class="cta-btn primary">Explore Now</a>
                <!-- If not authenticated as either (guest for both) -->
                @else
                    <!-- For regular user guests -->
                    <a href="{{ route('register') }}" class="cta-btn primary">Get Started</a>
                    <a href="{{ route('login') }}" class="cta-btn secondary">Login</a>
                @endauth
            </div>
        </section>
    </div>
